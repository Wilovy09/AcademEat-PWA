...
<template>
  <div class="z-0">
    ...
    <div class="flex">
      <input :type="isPassword ? 'password' : 'text'" :value="modelValue" :autocomplete="hasAutocomplete" @input="
      ...
      <button v-if="props.type === 'password' && props.hasEye" @click="togglePasswordVisibility" type="button"
